...
use iced_fonts::{
    bootstrap::{caret_down_fill, caret_up, caret_up_fill},
    BOOTSTRAP_FONT,
};
    ...
    Theme: number_input::ExtendedCatalog,
{
    ...
    fn update(
        ...
        let sub_redraw = sub_shell.redraw_request();
        shell.request_redraw_at(sub_redraw);
    ...
    fn draw(
        ...
        renderer.fill_text(
            iced::advanced::text::Text {
                content: char::from_u32(0xF229).unwrap().to_string(),
        ...
        renderer.fill_text(
            iced::advanced::text::Text {
                content: char::from_u32(0xF235).unwrap().to_string(),
